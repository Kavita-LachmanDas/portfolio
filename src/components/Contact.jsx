    ...
    <div id="contactus" className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Map Section */}
          <div className={`w-full lg:w-2/3 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl overflow-hidden shadow-2xl border border-white/20 relative group">
              {/* Map Container with proper height */}
              <div className="h-64 sm:h-80 lg:h-96 xl:h-full min-h-[400px] w-full">
                <iframe
                  width="100%"
                  height="100%"
                  className="absolute inset-0 transition-all duration-500 group-hover:scale-105"
              ...
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
                <div className="bg-white/95 backdrop-blur-md rounded-2xl p-4 sm:p-6 shadow-2xl transform transition-all duration-500 hover:scale-105">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    <div className="flex items-start space-x-3">
                      <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-2 sm:p-3 rounded-full flex-shrink-0">
                        <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                      </div>
                      <div className="min-w-0">
                        <h3 className="font-semibold text-gray-900 text-xs sm:text-sm uppercase">Address</h3>
                        <p className="text-gray-600 mt-1 text-xs sm:text-sm leading-tight">Eros Complex near Nasheman Cinema Saddar Karachi</p>
                      </div>
                    </div>

                    <div className="flex items-start space-x-3">
                      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 p-2 sm:p-3 rounded-full flex-shrink-0">
                        <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                      </div>
                      <div className="min-w-0">
                        <h3 className="font-semibold text-gray-900 text-xs sm:text-sm uppercase">Email</h3>
                        <a href="mailto:kavitaluhana11@gmail.com" className="text-blue-600 hover:text-blue-800 mt-1 text-xs sm:text-sm break-all">
                          kavitaluhana11@gmail.com
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3 sm:col-span-2 lg:col-span-1">
                      <div className="bg-gradient-to-r from-green-500 to-teal-500 p-2 sm:p-3 rounded-full flex-shrink-0">
                        <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                      </div>
                      <div className="min-w-0">
                        <h3 className="font-semibold text-gray-900 text-xs sm:text-sm uppercase">Phone</h3>
                        <a href="tel:03197946724" className="text-green-600 hover:text-green-800 mt-1 text-xs sm:text-sm">
                          03197946724
                        </a>
                      </div>
                    </div>
          ...
          {/* Contact Form */}
          <div className={`w-full lg:w-1/3 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 h-full">
              {!isSubmitted ? (
                <>
                  <div className="mb-6 sm:mb-8">
                    <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-400 bg-clip-text text-transparent mb-3">Send Message</h3>
                    <p className="text-gray-500 text-sm sm:text-base">I'd love to hear from you. Send me a message and I'll respond as soon as possible.</p>
                  </div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onFocus={() => setFocusedField('name')}
                        onBlur={() => setFocusedField('')}
                        className="w-full bg-white/90 border border-gray-300 rounded-2xl py-3 sm:py-4 pl-12 sm:pl-14 pr-4 text-gray-900 placeholder-gray-500 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 backdrop-blur-sm transition-all duration-200 text-sm sm:text-base"
                        placeholder="Your Name"
                        required
                      />
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onFocus={() => setFocusedField('message')}
                        onBlur={() => setFocusedField('')}
                        className="w-full bg-white/90 border border-gray-300 rounded-2xl py-3 sm:py-4 pl-12 sm:pl-14 pr-4 text-gray-900 placeholder-gray-500 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 backdrop-blur-sm resize-none transition-all duration-200 text-sm sm:text-base"
                        placeholder="Your message here..."
                        required
                      />
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={handleSub}
                      className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold py-3 sm:py-4 rounded-2xl transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2 transition-all duration-200 text-sm sm:text-base"
                    >
                      <span>Send Message</span>
                ...
                <div className="text-center py-8 sm:py-12">
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-green-500 rounded-full mb-4 sm:mb-6 animate-bounce">
